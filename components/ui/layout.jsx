...
const Layout = React.forwardRef(function Layout({ className, fadedBelow = false, fixedHeight = false, ...props }, ref) {
  return (
    <div
      ref={ref}
      className={cn(
...
const LayoutHeader = React.forwardRef(function LayoutHeader({ className, ...props }, ref) {
  return (
    <div
      ref={ref}
      className={cn(
...
const LayoutBody = React.forwardRef(function LayoutBody({ className, fixedHeight, ...props }, ref) {
  return (
    <div
      ref={ref}
      className={cn(
